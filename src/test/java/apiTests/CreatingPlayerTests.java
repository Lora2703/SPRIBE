...
public class CreatingPlayerTests {
    ...
    @Test(priority = 0, dataProvider = "CreatePlayerForCreatingPlayerTests", dataProviderClass = DataProviders.class)
    ...
    @Test(priority = 1, dataProvider = "DeletePlayerForCreatingPlayerTests", dataProviderClass = DataProviders.class)
